  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Vefat Edenler</Text>
      ...
      <View style={styles.content}>
        ...
        {!isLoading && error && (
          <Text style={styles.errorText}>Vefat ilanları yüklenemedi.</Text>
        )}
        {!isLoading && !error && visibleIlanlar.length === 0 && (
          <Text style={styles.emptyText}>Gösterilecek ilan bulunmuyor.</Text>
        )}
              ...
              <Card key={ilan.id} style={styles.card}>
                <View style={styles.cardHeader}>
                  ...
                  <View style={styles.nameBlock}>
                    ...
                    <Text style={styles.age}>{ilan.yas} Yaşında</Text>
                  </View>
                </View>
