export const tr = {
  ...
  randevuAl_empty: "Şu anda başvuru alınabilecek bir hizmet bulunmuyor.",
  randevuAl_error: "Başvuru türleri yüklenemedi.",
  randevuAl_myApplications: "Başvurularım",

  basvuruForm_kimlikNoLabel: "T.C. Kimlik No",
  basvuruForm_adSoyadLabel: "Ad Soyad",
  basvuruForm_dogumTarihiLabel: "Doğum Tarihi",
  basvuruForm_dogumTarihiSecPlaceholder: "Tarih seçin",
  basvuruForm_adresLabel: "Adres",
  basvuruForm_ekBilgilerTitle: "Ek Bilgiler",
  basvuruForm_belgelerTitle: "Gerekli Belgeler",
  basvuruForm_belgeEkle: "Belge Ekle",
  basvuruForm_belgeKaldir: "Kaldır",
  basvuruForm_belgeSecenekFoto: "Fotoğraf",
  basvuruForm_belgeSecenekPdf: "Belge (PDF)",
  basvuruForm_fotografEklendi: "Fotoğraf eklendi",
  basvuruForm_pdfSecimHata: "Belge seçilemedi, lütfen tekrar deneyin.",
  basvuruForm_dosyaBoyutuHata: "Dosya çok büyük (maksimum 3MB).",
  basvuruForm_toplamBoyutHata:
    "Eklenen belgelerin toplam boyutu çok büyük, lütfen bir belgeyi kaldırın.",
  basvuruForm_validationTitle: "Eksik Bilgi",
  basvuruForm_validationMessage: "Lütfen şu alanları doldurun: {alanlar}",
  basvuruForm_submit: "Başvuruyu Gönder",
  basvuruForm_submitting: "Gönderiliyor...",
  basvuruForm_successTitle: "Başvurunuz Alındı",
  basvuruForm_successMessage:
    "Başvurunuz oluşturuldu. Durumunu Başvurularım ekranından takip edebilirsiniz.",
  basvuruForm_errorTitle: "Başvuru Gönderilemedi",
  basvuruForm_errorMessage: "Bir hata oluştu, lütfen tekrar deneyin.",

  basvurularim_title: "Başvurularım",
  basvurularim_newApplication: "Yeni Başvuru Yap",
  basvurularim_currentApplications: "Mevcut Başvurularınız",
  basvurularim_recordCount: "{count} Kayıt",
  basvurularim_error: "Başvurularınız yüklenemedi.",
  basvurularim_empty:
    "Henüz bir başvurunuz yok. “Yeni Başvuru Yap” ile başlayabilirsiniz.",
  basvurularim_statusPending: "Beklemede",
  ...
  services_elektrikKesintileri: "Elektrik Kesintileri",
  services_elektrikVeSuKesintileri: "Elektrik ve Su Kesintileri",
  ...
  elektrikKesintileri_title: "Elektrik Kesintileri",
  elektrikKesintileri_error: "Elektrik kesintileri yüklenemedi.",
  elektrikKesintileri_empty: "Şu anda planlı elektrik kesintisi bulunmuyor.",
  elektrikVeSuKesintileri_title: "Elektrik ve Su Kesintileri",
  elektrikVeSuKesintileri_suBaslik: "Su Kesintileri",
  elektrikVeSuKesintileri_elektrikBaslik: "Elektrik Kesintileri",
  elektrikVeSuKesintileri_hata: "Kesinti bilgisi yüklenemedi.",
  elektrikVeSuKesintileri_bos: "Şu anda planlı kesinti bulunmuyor.",
