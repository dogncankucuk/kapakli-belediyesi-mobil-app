...
function MakalelerPage({ canManage }: Props) {
  ...
  async function handleCreate(e: FormEvent) {
    ...
    setError(null);
    try {
      await createMakale({ ...form, youtubeUrl: form.youtubeUrl || null });
  ...
  async function handleUpdate(id: string) {
    setError(null);
    try {
      await updateMakale(id, { ...editForm, youtubeUrl: editForm.youtubeUrl || null });
      setEditingId(null);
      await load();
    } catch (err) {
    ...
    <div className="page">
      ...
      {canManage && (
        <div className="guncel-sag">
          ...
          <TelefonOnizleme baslik="Makaleler">
